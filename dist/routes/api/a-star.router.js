...
const a_star_controller_1 = require("../../controllers/uni-directional/a-star.controller");
const validata_request_middleware_1 = require("../../middleware/validata-request.middleware");
exports.router = (0, express_1.Router)();
exports.router.route("/")
    .post(dijkstra_schema_1.pathfindingScheme2D, validata_request_middleware_1.validateRequestPathfinding, a_star_controller_1.startAStar)
